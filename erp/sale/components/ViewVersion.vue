...
export default {
  name: "ViewVersion",
  components: {UvCountTo, QiunDataCharts, UniGridItem, UniGrid},
  data: () => ({
    chartData: {},
    ...
    <UniGrid :column="2" :square="false" :show-border="false">
      <UniGridItem>
        <view class="ko-view-version__item">
          <view>销售订单总额</view>
          <view>
            <UvCountTo separator="," :start-val="0" :end-val="data.totalSignAmount" color="#2979ff" />
            <text>元</text>
          </view>
        </view>
      </UniGridItem>
      <UniGridItem>
        <view class="ko-view-version__item">
          <view>签单客户</view>
          <view>
            <UvCountTo :start-val="0" :end-val="500" color="#e43d33" />
            <text>元</text>
          </view>
        </view>
      </UniGridItem>
