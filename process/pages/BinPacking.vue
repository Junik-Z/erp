...
import UvCheckbox from "../components/uv-checkbox/uv-checkbox/uv-checkbox.vue";
        ...
        },
        {
          ...
          render: (h, {row}) => {
            ...
            return h("el-select", {
              ...
              this.weightList.map(item => h("el-option", {props: {value: item.value, label: item.name}})),
            );
          },
          // #endif
        },
    ...
    getColumns() {
      ...
      const col = [
        ...
        },
        {
          ...
          // #ifdef H5
          render(h, {row}) {
            return h("el-checkbox", {props: {disabled: true, value: row.texture}});
          },
          // #endif
        },
        {
          ...
          // #ifdef H5
          render(h, {row}) {
            return h("el-checkbox", {props: {disabled: true, value: row.rotate}});
          },
          // #endif
        },
        {
