    ...
    <view class="textarea">
      <view class="page-body">
        <view class='wrapper'>
          ...
          <view v-show="!readOnly" class='toolbar' @tap="format">
      ...
      uni.chooseMedia({
        ...
        success: (chooseImageRes) => {
          ...
          fs.readFile({
            ...
            encoding: "base64",
            success: (e) => {
              uploadBase64Api({base64: "data:image/png;base64," + e.data})
                .then(res => {
                  console.log(res);
                  this.img = this.photoUrl + res.data;
                  this.editorCtx.insertImage({
                    src: this.img,
                    alt: "图像",
                    success: function () {
