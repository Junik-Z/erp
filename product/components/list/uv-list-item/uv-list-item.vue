          ...
          <view class="uv-list-item__container"
            ...
            <slot name="header">
              <view class="uv-list-item__header">
                ...
                <view v-else-if="showExtraIcon" class="uv-list-item__icon">
                  <uni-icons :type="extraIcon.icon" :customPrefix="extraIcon.customPrefix" :color="extraIcon.color"
                             :size="extraIcon.size" />
                </view>
              </view>
            </slot>
            ...
            <slot name="footer">
              <view v-if="rightText || showBadge || showSwitch" class="uv-list-item__extra"
                ...
                ></UvBadge>
                <switch v-if="showSwitch" :value="switchChecked" :disabled="disabled" @change="onSwitchChange" />
              </view>
            </slot>
          </view>
        </slot>
      </view>
      <uni-icons v-if="showArrow || link" size="34rpx" class="uv-icon-wrapper" color="#bbb" type="right" />
    </view>
    <!-- #ifdef APP-NVUE -->
  </cell>
  <!-- #endif -->
...
import UvBadge from "../uv-badge/uv-badge.vue";
