...
export default {
  ...
  methods: {
    ...
    // 开始
    onStart() {
      this.AVM.startRecord();
    },

    // 开始
    onEnd() {
      this.AVM.pauseRecord();
    },
  },
  computed: {
    getShopImage() {
...
<template>
  <view class="ko-smart">
    <image class="ko-smart__bg--image" :src="getShopImage" mode="heightFix" />
    <view class="ko-smart__bg">
    </view>
    ...
    <view class="ko-basic-footer ko-smart__footer" v-if="false">
