<template>
  ...
  >
      ...
      <slot name="icon">
        ...
        >
          <i
            ...
            class="iconfont" :class="[index <= parentData.current ? 'icon-duigou' : 'icon-cha']"
          ></i>
        </view>
        <view
          v-else
          ...
          <i
            v-else
            :style="{color: statusClass === 'error' ? '#f36161' : parentData.activeColor,fontSize: '12px'}"
            class="iconfont" :class="[statusClass === 'error' ? 'icon-cha' : 'icon-duigou']"
          ></i>
        </view>
      </slot>
    </view>
    ...
    >
      ...
      <slot name="desc">
        <view class="ko-steps-item__desc">{{ desc }}</view>
      </slot>
    </view>
  </view>
</template>
