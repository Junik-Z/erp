        ...
        <view class="uv-cell__title">
          ...
          <slot name="label">
            <text class="uv-cell__label" v-if="label"
                  :class="[disabled && 'uv-cell--disabled', size === 'large' && 'uv-cell__label--large']">{{ label }}
            </text>
          </slot>
        </view>
      </view>
...
@import '@/uni_modules/uv-ui-tools/libs/css/components';
@import '@/uni_modules/uv-ui-tools/libs/css/color';

$uv-cell-padding: 6px 12px !default;
$uv-cell-font-size: 14px !default;
$uv-cell-line-height: 16px !default;
$uv-cell-color: $uv-main-color !default;
$uv-cell-icon-size: 16px !default;
$uv-cell-title-font-size: 14px !default;
$uv-cell-title-line-height: 16px !default;
...
$uv-cell-value-font-size: 12px !default;
