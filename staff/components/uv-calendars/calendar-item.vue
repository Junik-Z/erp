  ...
  <view class="uv-calendar-item__weeks-box" :class="{
    ...
    <view class="uv-calendar-item__weeks-box-item">
      <text
        ...
        :style="{background: weeks.extraInfo.badgeBgc}"
      ></text>
      <text class="uv-calendar-item__weeks-top-text" v-if="weeks.extraInfo&&weeks.extraInfo.topinfo"
            :style="[infoStyle('top')]">{{ weeks.extraInfo && weeks.extraInfo.topinfo }}
      </text>
      ...
      <text v-if="weeks.extraInfo&&weeks.extraInfo.info" class="uv-calendar-item__weeks-lunar-text" :class="{
					...
					}" :style="[infoStyle('bottom')]">{{ weeks.extraInfo.info }}
      </text>
    </view>
  </view>
</template>
